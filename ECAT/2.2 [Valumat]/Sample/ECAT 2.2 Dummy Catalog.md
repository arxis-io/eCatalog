This is the Dummy Catalog, in ECAT 2.2 language.
...
<General>
  ...
  <OptionGTINDefinitions>
    ...
    <OptionDefinition>
      ...
      <Values>
        <Value>5499990000006</Value>
        <!-- 190 -->
        <Value>5499990000007</Value>
        <!-- 200 -->
        <Value>5499990000008</Value>
        <!-- 210 -->
        <Value>5499990000009</Value>
        <!-- 220 -->
      </Values>
    </OptionDefinition>
    <OptionDefinition>
      ...
      <Values>
        <Value>5499990000016</Value>
        <!-- Firm -->
        <Value>5499990000017</Value>
        <!-- Soft -->
        <Value>5499990000018</Value>
        <!-- Medium -->
      </Values>
    </OptionDefinition>
    <OptionDefinition>
		...
		<CountryOrigin>BE</CountryOrigin>
              <Options>
                <Option order="50" definition="Program">
                  ...
                  <!-- Breedte -->
                  <Values>
                    <!--Breedte heeft std values 70,80,90 maar hier worden nog extra value gedefinieerd -->
              ...
              <Configurations>
                <Configuration action="Add">
                  ...
                  <!-- split | split aan hoofd en voeteinde -->
                ...
                <Configuration action="Add">
                  ...
                  <!-- automatisch met afstandsbediening -->
                </Configuration>
                ...
                <Configuration action="Remove">
                  ...
                  <Conditions type="IF CONDITIONS NOT MET">
                    ...
                    <!--value is niet mogelijk tenzij voldaan is aan  -->
                    <Condition>
                ...
                <Configuration action="Remove">
                  ...
                  <Conditions type="IF CONDITIONS MET">
                    ...
                    <!--value is niet mogelijk als voldaan is aan  -->
                    <Condition>
                      <Option>5499990000001</Option>
              ...
              <Prices>
                ...
                <Price>
                  ...
                  <Conditions>
                    <Condition>
                      <Option>5499990000021</Option>

                      <!--split  -->
                      <Value>5499990000023</Value>
                ...
                <Price>
                  ...
                  <!--meerprijs voor een subvalue  -->
                  <SalesPrice>125.00</SalesPrice>
                  <RetailPrice>250.00</RetailPrice>
                  <Conditions>
                    <Condition>
                      <Option>5499990000021|5499990000023</Option>
                      <!--Split | split aan hoofd en voeteinde  -->
                      <Value>5499990000037</Value>
                      <!--automatisch met afstandsbediening  -->
                    </Condition>
                  </Conditions>
                </Price>
          ...
          <Configurations>
            <!--Configuratieregels op programma niveau, geldend voor alle artikelen van dit programma  -->
            <Configuration action="Remove">
              <!--deze value is niet mogelijk  -->
              <OptionToConfigure>5499990000014</OptionToConfigure>
              <!--Comfort  -->
              <ValueToConfigure>5499990000018</ValueToConfigure>
              <!--Medium  -->
            </Configuration>
            <Configuration action="Remove">
              <OptionToConfigure>5499990000005</OptionToConfigure>
              <!--Lengte  -->
              <ValueToConfigure>5499990000009</ValueToConfigure>
              <!--220  -->
              <Conditions type="IF CONDITIONS MET">
                <!--is niet mogelijk als: ...  -->
                <Condition>
                  <Option>5499990000014</Option>
                  <!--Comfort  -->
                  <Values>
                    <Value>5499990000016</Value>
                    <!--Firm -->
